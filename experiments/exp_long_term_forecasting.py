...
from utils.tools import EarlyStopping, adjust_learning_rate1, adjust_learning_rate2
...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        if self.args.use_scheduler or self.args.lradj == 'TST':
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(train_loader):
                ...
                if self.args.lradj == 'TST':
                    adjust_learning_rate1(model_optim, scheduler, epoch + 1, self.args, printout=False)
                    scheduler.step()
            ...
            if self.args.lradj != 'TST':
                adjust_learning_rate2(model_optim, epoch + 1, self.args)
            else:
